...
const ANSWER_STYLE_COPY = Object.freeze({
  english: { label: 'Answer style', simple: 'Simple', technical: 'Technical', simpleDescription: 'Clear, everyday astrology', technicalDescription: 'Full calculations and terminology', selectionTitle: 'You’re using {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. Choose the consultation mode and answer style, then continue.' },
  hindi: { label: 'उत्तर शैली', simple: 'सरल', technical: 'तकनीकी', simpleDescription: 'साफ़, रोज़मर्रा की भाषा में ज्योतिष', technicalDescription: 'पूरी गणनाएँ और ज्योतिषीय शब्दावली', selectionTitle: 'आप {{mode}} · {{style}} उपयोग कर रहे हैं', selectionBody: '{{styleDescription}}। परामर्श मोड और उत्तर शैली चुनें, फिर आगे बढ़ें।' },
  es: { label: 'Estilo de respuesta', simple: 'Simple', technical: 'Técnica', simpleDescription: 'Astrología clara y cotidiana', technicalDescription: 'Cálculos y terminología completos', selectionTitle: 'Estás usando {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. Elige el modo de consulta y el estilo de respuesta, y continúa.' },
  ...
  german: { label: 'Antwortstil', simple: 'Einfach', technical: 'Technisch', simpleDescription: 'Klare Astrologie in Alltagssprache', technicalDescription: 'Vollständige Berechnungen und Fachbegriffe', selectionTitle: 'Du verwendest {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. Wähle Beratungsmodus und Antwortstil und fahre dann fort.' },
  russian: { label: 'Стиль ответа', simple: 'Простой', technical: 'Технический', simpleDescription: 'Понятная астрология простыми словами', technicalDescription: 'Полные расчёты и терминология', selectionTitle: 'Вы используете {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. Выберите режим консультации и стиль ответа, затем продолжите.' },
  chinese: { label: '回答风格', simple: '简明', technical: '专业', simpleDescription: '清晰易懂的日常占星解读', technicalDescription: '完整计算与专业术语', selectionTitle: '当前使用：{{mode}} · {{style}}', selectionBody: '{{styleDescription}}。请选择咨询模式和回答风格，然后继续。' },
  tamil: { label: 'பதில் பாணி', simple: 'எளிமை', technical: 'தொழில்நுட்பம்', simpleDescription: 'தெளிவான அன்றாட மொழியில் ஜோதிடம்', technicalDescription: 'முழு கணக்கீடுகளும் கலைச்சொற்களும்', selectionTitle: 'நீங்கள் பயன்படுத்துவது {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. ஆலோசனை முறையையும் பதில் பாணியையும் தேர்ந்தெடுத்து தொடரவும்.' },
  telugu: { label: 'సమాధాన శైలి', simple: 'సరళం', technical: 'సాంకేతికం', simpleDescription: 'స్పష్టమైన రోజువారీ భాషలో జ్యోతిష్యం', technicalDescription: 'పూర్తి లెక్కలు మరియు పరిభాష', selectionTitle: 'మీరు ఉపయోగిస్తున్నది {{mode}} · {{style}}', selectionBody: '{{styleDescription}}. సంప్రదింపు మోడ్ మరియు సమాధాన శైలిని ఎంచుకుని కొనసాగండి.' },
  gujarati: { label: 'જવાબની શૈલી', simple: 'સરળ', technical: 'ટેક્નિકલ', simpleDescription: 'સ્પષ્ટ, રોજિંદી ભાષામાં જ્યોતિષ', technicalDescription: 'સંપૂર્ણ ગણતરીઓ અને પરિભાષા', selectionTitle: 'તમે {{mode}} · {{style}} વાપરી રહ્યા છો', selectionBody: '{{styleDescription}}. પરામર્શ મોડ અને જવાબની શૈલી પસંદ કરીને આગળ વધો.' },
  marathi: { label: 'उत्तर शैली', simple: 'सोपे', technical: 'तांत्रिक', simpleDescription: 'स्पष्ट, रोजच्या भाषेतील ज्योतिष', technicalDescription: 'संपूर्ण गणना आणि ज्योतिषीय संज्ञा', selectionTitle: 'तुम्ही {{mode}} · {{style}} वापरत आहात', selectionBody: '{{styleDescription}}. सल्ल्याचा मोड आणि उत्तर शैली निवडा, नंतर पुढे जा.' },
});
