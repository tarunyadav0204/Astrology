...
import prashnaV2 from './prashna-v2.json';
...
i18n
  ...
  .init({
    resources: {
      english: {
        translation: { ...en, eventTimelineSample: eventTimelineSample.english, ashtakavargaUi: ashtakavargaUi.english, ashtakavargaStudy: ashtakavargaStudy.english, premiumUi: { ...normalizedPremiumUi.english, homeRecommendations: homeRecommendations.english }, themeDiscovery: themeDiscovery.english, appUpdate: appUpdate.english, lifeAnalysisFlow: { ...lifeAnalysis.english, ...lifeAnalysisPdf.english }, historyUi: historyUi.english, historyDetail: historyDetail.english, knowledgeSupport: knowledgeSupport.english, notificationInbox: accountNotifications.english , prashna: prashnaV2.english },
      },
      es: {
        translation: { ...es, eventTimelineSample: eventTimelineSample.es, ashtakavargaUi: ashtakavargaUi.es, ashtakavargaStudy: ashtakavargaStudy.es, premiumUi: { ...normalizedPremiumUi.es, homeRecommendations: homeRecommendations.es }, themeDiscovery: themeDiscovery.es, appUpdate: appUpdate.es, lifeAnalysisFlow: { ...lifeAnalysis.es, ...lifeAnalysisPdf.es }, historyUi: historyUi.es, historyDetail: historyDetail.es, knowledgeSupport: knowledgeSupport.es, notificationInbox: accountNotifications.es , prashna: prashnaV2.es },
      },
      hindi: {
        translation: { ...hi, eventTimelineSample: eventTimelineSample.hindi, ashtakavargaUi: ashtakavargaUi.hindi, ashtakavargaStudy: ashtakavargaStudy.hindi, premiumUi: { ...normalizedPremiumUi.hindi, homeRecommendations: homeRecommendations.hindi }, themeDiscovery: themeDiscovery.hindi, appUpdate: appUpdate.hindi, lifeAnalysisFlow: { ...lifeAnalysis.hindi, ...lifeAnalysisPdf.hindi }, historyUi: historyUi.hindi, historyDetail: historyDetail.hindi, knowledgeSupport: knowledgeSupport.hindi, notificationInbox: accountNotifications.hindi , prashna: prashnaV2.hindi },
      },
      tamil: {
        translation: { ...tamil, eventTimelineSample: eventTimelineSample.tamil, ashtakavargaUi: ashtakavargaUi.tamil, ashtakavargaStudy: ashtakavargaStudy.tamil, premiumUi: { ...normalizedPremiumUi.tamil, homeRecommendations: homeRecommendations.tamil }, themeDiscovery: themeDiscovery.tamil, appUpdate: appUpdate.tamil, lifeAnalysisFlow: { ...lifeAnalysis.tamil, ...lifeAnalysisPdf.tamil }, historyUi: historyUi.tamil, historyDetail: historyDetail.tamil, knowledgeSupport: knowledgeSupport.tamil, notificationInbox: accountNotifications.tamil , prashna: prashnaV2.tamil },
      },
      telugu: {
        translation: { ...te, eventTimelineSample: eventTimelineSample.telugu, ashtakavargaUi: ashtakavargaUi.telugu, ashtakavargaStudy: ashtakavargaStudy.telugu, premiumUi: { ...normalizedPremiumUi.telugu, homeRecommendations: homeRecommendations.telugu }, themeDiscovery: themeDiscovery.telugu, appUpdate: appUpdate.telugu, lifeAnalysisFlow: { ...lifeAnalysis.telugu, ...lifeAnalysisPdf.telugu }, historyUi: historyUi.telugu, historyDetail: historyDetail.telugu, knowledgeSupport: knowledgeSupport.telugu, notificationInbox: accountNotifications.telugu , prashna: prashnaV2.telugu },
      },
      gujarati: {
        translation: { ...gu, eventTimelineSample: eventTimelineSample.gujarati, ashtakavargaUi: ashtakavargaUi.gujarati, ashtakavargaStudy: ashtakavargaStudy.gujarati, premiumUi: { ...normalizedPremiumUi.gujarati, homeRecommendations: homeRecommendations.gujarati }, themeDiscovery: themeDiscovery.gujarati, appUpdate: appUpdate.gujarati, lifeAnalysisFlow: { ...lifeAnalysis.gujarati, ...lifeAnalysisPdf.gujarati }, historyUi: historyUi.gujarati, historyDetail: historyDetail.gujarati, knowledgeSupport: knowledgeSupport.gujarati, notificationInbox: accountNotifications.gujarati , prashna: prashnaV2.gujarati },
      },
      marathi: {
        translation: { ...mr, eventTimelineSample: eventTimelineSample.marathi, ashtakavargaUi: ashtakavargaUi.marathi, ashtakavargaStudy: ashtakavargaStudy.marathi, premiumUi: { ...normalizedPremiumUi.marathi, homeRecommendations: homeRecommendations.marathi }, themeDiscovery: themeDiscovery.marathi, appUpdate: appUpdate.marathi, lifeAnalysisFlow: { ...lifeAnalysis.marathi, ...lifeAnalysisPdf.marathi }, historyUi: historyUi.marathi, historyDetail: historyDetail.marathi, knowledgeSupport: knowledgeSupport.marathi, notificationInbox: accountNotifications.marathi , prashna: prashnaV2.marathi },
      },
      german: {
        translation: { ...de, eventTimelineSample: eventTimelineSample.german, ashtakavargaUi: ashtakavargaUi.german, ashtakavargaStudy: ashtakavargaStudy.german, premiumUi: { ...normalizedPremiumUi.german, homeRecommendations: homeRecommendations.german }, themeDiscovery: themeDiscovery.german, appUpdate: appUpdate.german, lifeAnalysisFlow: { ...lifeAnalysis.de, ...lifeAnalysisPdf.de }, historyUi: historyUi.de, historyDetail: historyDetail.de, knowledgeSupport: knowledgeSupport.de, notificationInbox: accountNotifications.de , prashna: prashnaV2.german },
      },
      french: {
        translation: { ...fr, eventTimelineSample: eventTimelineSample.french, ashtakavargaUi: ashtakavargaUi.fr, ashtakavargaStudy: ashtakavargaStudy.fr, premiumUi: { ...normalizedPremiumUi.fr, homeRecommendations: homeRecommendations.fr }, themeDiscovery: themeDiscovery.fr, appUpdate: appUpdate.french, lifeAnalysisFlow: { ...lifeAnalysis.fr, ...lifeAnalysisPdf.fr }, historyUi: historyUi.fr, historyDetail: historyDetail.fr, knowledgeSupport: knowledgeSupport.fr, notificationInbox: accountNotifications.fr , prashna: prashnaV2.french },
      },
      russian: {
        translation: { ...ru, eventTimelineSample: eventTimelineSample.russian, ashtakavargaUi: ashtakavargaUi.russian, ashtakavargaStudy: ashtakavargaStudy.russian, premiumUi: { ...normalizedPremiumUi.russian, homeRecommendations: homeRecommendations.russian }, themeDiscovery: themeDiscovery.russian, appUpdate: appUpdate.russian, lifeAnalysisFlow: { ...lifeAnalysis.russian, ...lifeAnalysisPdf.russian }, historyUi: historyUi.russian, historyDetail: historyDetail.russian, knowledgeSupport: knowledgeSupport.russian, notificationInbox: accountNotifications.russian , prashna: prashnaV2.russian },
      },
      chinese: {
        translation: { ...zh, eventTimelineSample: eventTimelineSample.chinese, ashtakavargaUi: ashtakavargaUi.chinese, ashtakavargaStudy: ashtakavargaStudy.chinese, premiumUi: { ...normalizedPremiumUi.chinese, homeRecommendations: homeRecommendations.chinese }, themeDiscovery: themeDiscovery.chinese, appUpdate: appUpdate.chinese, lifeAnalysisFlow: { ...lifeAnalysis.chinese, ...lifeAnalysisPdf.chinese }, historyUi: historyUi.chinese, historyDetail: historyDetail.chinese, knowledgeSupport: knowledgeSupport.chinese, notificationInbox: accountNotifications.chinese , prashna: prashnaV2.chinese },
      },
      mandarin: {
        translation: { ...zh, eventTimelineSample: eventTimelineSample.chinese, ashtakavargaUi: ashtakavargaUi.chinese, ashtakavargaStudy: ashtakavargaStudy.chinese, premiumUi: { ...normalizedPremiumUi.chinese, homeRecommendations: homeRecommendations.chinese }, themeDiscovery: themeDiscovery.chinese, appUpdate: appUpdate.chinese, lifeAnalysisFlow: { ...lifeAnalysis.chinese, ...lifeAnalysisPdf.chinese }, historyUi: historyUi.chinese, historyDetail: historyDetail.chinese, knowledgeSupport: knowledgeSupport.chinese, notificationInbox: accountNotifications.chinese , prashna: prashnaV2.chinese },
      },
