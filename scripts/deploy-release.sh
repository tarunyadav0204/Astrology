...
NUDGE_AUDIENCE_DATABASE_SECRET_NAME="${NUDGE_AUDIENCE_DATABASE_SECRET_NAME:-NUDGE_AUDIENCE_DATABASE_URL}"
NUDGE_NOTIFICATION_DATABASE_SECRET_NAME="${NUDGE_NOTIFICATION_DATABASE_SECRET_NAME:-NUDGE_NOTIFICATION_DATABASE_URL}"
...
if [ "${SYNC_GCP_SECRETS}" = "true" ]; then
  ...
  overlay_gcp_secret_in_env_file "${NUDGE_TASKS_SECRET_NAME}" "NUDGE_TASKS_SECRET" "${APP_ROOT}/backend/.env"
  overlay_gcp_secret_in_env_file "${NUDGE_AUDIENCE_DATABASE_SECRET_NAME}" "NUDGE_AUDIENCE_DATABASE_URL" "${APP_ROOT}/backend/.env"
  overlay_gcp_secret_in_env_file "${NUDGE_NOTIFICATION_DATABASE_SECRET_NAME}" "NUDGE_NOTIFICATION_DATABASE_URL" "${APP_ROOT}/backend/.env"
