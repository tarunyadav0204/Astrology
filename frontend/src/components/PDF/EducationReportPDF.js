...
export const EducationReportPDF = ({ data, userName }) => {
  // Handle both old and new data formats
  const analysis = data?.education_analysis?.json_response || data?.analysis || {};
  
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>Vedic Education Analysis</Text>
        ...
        <Text style={styles.disclaimer}>
          Education insights are for guidance purposes only. Academic success depends on effort and dedication.
        </Text>
      </Page>
    </Document>
  );
