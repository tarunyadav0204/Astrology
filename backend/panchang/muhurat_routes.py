...
async def get_vivah_muhurat(date: str, latitude: float, longitude: float):
    ...
    try:
        result = calculator.calculate_vivah_muhurat(date, latitude, longitude)
        return result
...
async def get_property_muhurat(date: str, latitude: float, longitude: float):
    ...
    try:
        result = calculator.calculate_property_muhurat(date, latitude, longitude)
        return result
    except Exception as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def get_vehicle_muhurat(date: str, latitude: float, longitude: float):
    ...
    try:
        result = calculator.calculate_vehicle_muhurat(date, latitude, longitude)
        return result
    except Exception as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def get_griha_pravesh_muhurat(date: str, latitude: float, longitude: float):
    ...
    try:
        result = calculator.calculate_griha_pravesh_muhurat(date, latitude, longitude)
        return result
    except Exception as e:
        raise HTTPException(status_code=400, detail=str(e))