from credits.free_answer_funnel import VALID_EVENTS, _inclusive_date_clause, get_funnel_analytics, record_funnel_event
...
def test_get_funnel_analytics_shape_without_db(monkeypatch):
    ...
    def fake_execute(conn, sql, params=None):
        ...
        assert "free_question_completed" in sql
        return FakeCur()
    ...
    assert out["impression_source"] == "chat_messages.gate_metadata.free_question_completed"
