...
async def get_admin_chat_user_thread(
    ...
    try:
        ...
        with get_conn() as conn:
            ...
            has_response_style = "response_style" in msg_cols
...
async def get_all_settings(current_user: dict = Depends(require_admin)):
    ...
    try:
        ...
        return {
            ...
            "deepseek_report_model": get_deepseek_report_model(),
            "deepseek_timeline_model": get_deepseek_timeline_model(),
            ...
            "podcast_tts_voice_en_female": get_podcast_tts_voices("en")[0],
            "podcast_tts_voice_en_male": get_podcast_tts_voices("en")[1],
            "podcast_tts_voice_hi_female": get_podcast_tts_voices("hi")[0],
            "podcast_tts_voice_hi_male": get_podcast_tts_voices("hi")[1],
            ...
            "speech_processing_bridge_model": get_speech_processing_bridge_model(),
            "speech_processing_bridge_detail_level": get_speech_processing_bridge_detail_level(),
            "speech_chat_user_allowlist": ",".join(
                str(uid) for uid in sorted(get_speech_chat_user_allowlist())
            ),
            "play_payment_service_enabled": is_play_payment_service_enabled(),
            "play_payment_service_user_allowlist": ",".join(
            ...
            "home_screen_banner": get_home_screen_banner(),
