...
from reports.llm.janam_kundli_premium_report import generate_janam_kundli_premium_report as _generate_janam_kundli_premium_report
...
async def generate_janam_kundli_premium_report(
    ...
    *,
    ...
    return await _generate_janam_kundli_premium_report(
        userid,
        context,
        language=language or "english",
        force_regenerate=force_regenerate,
