    ...
    *,
    ...
    return {
        ...
        "technical_terms_rule": (
            ...
            "specialist terms through a natural explanation in the answer's controlling language; never repeat the "
            "same term as an English/Hindi or other bilingual parenthetical pair. Use only details present in the supplied evidence. Do not expose graph "
