...
const loadHomeData = async (nativeData = null) => {
        ...
        >
          ...
          >
            ...
            <View style={[styles.emptyStateCard, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : colors.surface, borderColor: colors.cardBorder }]}>
              ...
              >
                <LinearGradient
                  colors={isClassic ? [colors.text, colors.textSecondary] : ['#FF6B35', '#F7931E', '#FFD700']}
            ...
            {panchangData?.sunrise_sunset && (
              <View style={[styles.emptyStatePanchang, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : colors.surface, borderColor: colors.cardBorder }]}>
  ...
  const options = IS_ASTROLOGY_ONLY ? [] : [
    {
      id: 'question',
      icon: '💬',
  ...
  const useGlass = Platform.OS === 'ios' && !isClassic;
  const headerCardStyle = isLightOrClassic ? { borderColor: colors.cardBorder, borderWidth: 1, backgroundColor: isClassic ? colors.cardBackground : undefined } : {};
  const tickerCardStyle = isLightOrClassic ? { backgroundColor: isClassic ? colors.cardBackground : colors.surface, borderColor: colors.cardBorder, borderWidth: 1 } : {};
  const dashaCardStyle = isLightOrClassic ? { backgroundColor: isClassic ? colors.cardBackground : colors.surface, borderColor: colors.cardBorder, borderWidth: 1 } : {};
  const toolCardInnerStyle = isClassic ? { backgroundColor: colors.cardBackground, borderColor: colors.cardBorder, borderWidth: 1 } : undefined;
  const headerGlassColors = theme === 'dark' ? ['rgba(255,255,255,0.14)', 'rgba(255,255,255,0.06)'] : ['rgba(255,255,255,0.45)', 'rgba(255,247,237,0.28)', 'rgba(255,237,213,0.22)'];
      ...
      >
        ...
        <View style={styles.header}>
          <View style={[styles.headerDashboard, androidLightCardFixStyle, headerCardStyle, useGlass && { overflow: 'hidden', padding: 0 }]}>
            {useGlass && (
              <>
                <BlurView intensity={52} style={StyleSheet.absoluteFill} tint={theme === 'dark' ? 'dark' : 'light'} />
                <LinearGradient colors={headerGlassColors} style={[StyleSheet.absoluteFill, { borderRadius: 24 }]} />
              </>
            )}
            <LinearGradient
              colors={useGlass ? ['transparent', 'transparent'] : (theme === 'dark' 
              ...
              style={[!useGlass && styles.headerDashboard, androidLightCardFixStyle, headerCardStyle, useGlass && { ...StyleSheet.absoluteFillObject, padding: 16, borderWidth: 0 }]}
            >
            <View style={styles.headerTopRow}>
              ...
              <NativeSelectorChip 
                ...
                maxLength={10}
                showIcon={false}
                style={isClassic ? { backgroundColor: colors.surface, borderColor: colors.cardBorder, paddingVertical: 4, paddingHorizontal: 10 } : styles.headerNativeChip}
              />
            </View>

            <View style={[styles.headerBigThree, isLightOrClassic && { backgroundColor: isClassic ? colors.surface : colors.surface }]}>
              <TouchableOpacity 
              ...
              >
                <View style={[styles.headerSignIcon, { backgroundColor: theme === 'dark' ? '#3B82F620' : isClassic ? 'rgba(0, 0, 0, 0.08)' : 'rgba(59, 130, 246, 0.12)' }]}>
                  <Text style={[styles.headerSignEmoji, isClassic && { color: colors.text }]}>
              ...
              <View style={[styles.headerDivider, isLightOrClassic && { backgroundColor: colors.cardBorder }]} />
              ...
              >
                <View style={[styles.headerSignIcon, { backgroundColor: theme === 'dark' ? '#DC262620' : isClassic ? 'rgba(0, 0, 0, 0.08)' : 'rgba(220, 38, 38, 0.12)' }]}>
                  <Text style={[styles.headerSignEmoji, isClassic && { color: colors.text }]}>
              ...
              >
                <View style={[styles.headerSignIcon, { backgroundColor: theme === 'dark' ? '#F59E0B20' : isClassic ? 'rgba(0, 0, 0, 0.08)' : 'rgba(245, 158, 11, 0.2)' }]}>
                  <Text style={[styles.headerSignEmoji, isClassic && { color: colors.text }]}>
              ...
              <>
                ...
                >
                  <TickerItem 
                    ...
                    color={isClassic ? colors.text : '#F59E0B'}
                    showInfoIcon
                  />
                </TouchableOpacity>
                <View style={[styles.tickerSeparator, isLightOrClassic && { backgroundColor: colors.cardBorder }]} />
                <TouchableOpacity
                  activeOpacity={0.8}
                ...
                >
                  <TickerItem 
                    ...
                    color={isClassic ? colors.textSecondary : '#8B5CF6'}
                    showInfoIcon
                  />
                </TouchableOpacity>
                <View style={[styles.tickerSeparator, isLightOrClassic && { backgroundColor: colors.cardBorder }]} />
                ...
                >
                  <TickerItem 
                    ...
                    color={isClassic ? colors.text : (tickerData.sadeSati ? '#EF4444' : '#10B981')}
                    showInfoIcon
                  />
                </TouchableOpacity>
              </>
        ...
        <View style={styles.dashboardContainer}>
              ...
              <View style={styles.insightModalContent}>
                ...
                >
                  <View style={styles.insightHeader}>
                    {isClassic ? <Icon name="information-circle-outline" size={32} color={colors.text} /> : <Text style={styles.insightEmoji}>{activeInsight?.icon}</Text>}
          ...
          {dashData && (
            <TouchableOpacity
              style={[styles.dashaTimelineContainer, androidLightCardFixStyle, dashaCardStyle, useGlass && { overflow: 'hidden' }]}
              onPress={() => setShowDashaBrowser && setShowDashaBrowser(true)}
              activeOpacity={0.85}
            >
              {useGlass && <BlurView intensity={48} style={StyleSheet.absoluteFill} tint={theme === 'dark' ? 'dark' : 'light'} />}
              {useGlass && <View style={[StyleSheet.absoluteFill, { backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.2)' }]} pointerEvents="none" />}
                    ...
                    <View key={item.level} style={styles.timelineRow}>
                      ...
                      <View style={styles.timelineContent}>
                        <View style={styles.timelineHeader}>
                          <Text style={[styles.timelinePlanet, { color: isClassic ? colors.text : planetColor }]}>
                        ...
                        <View style={styles.progressContainer}>
                          <View style={[styles.progressBar, { backgroundColor: (colors.textSecondary || '#ffffff') + '10' }]}>
                            <View style={[styles.progressFill, { width: `${progress}%`, backgroundColor: isClassic ? colors.primary : planetColor }]} />
                          </View>
...
<View style={[styles.toolMiniStat, { backgroundColor: theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.08)' }]}>
          ...
          <View style={[styles.planetarySection, isLightOrClassic && { backgroundColor: colors.cardBackground, borderColor: colors.cardBorder, borderWidth: 1 }, useGlass && { overflow: 'hidden' }]}>
            {useGlass && <BlurView intensity={48} style={StyleSheet.absoluteFill} tint={theme === 'dark' ? 'dark' : 'light'} />}
            {useGlass && <View style={[StyleSheet.absoluteFill, { backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.2)' }]} pointerEvents="none" />}
            <View style={styles.planetaryHeader}>
              ...
              <View style={styles.planetaryHeaderRight}>
                <TouchableOpacity
                  style={[styles.cosmicRingChip, isClassic ? { backgroundColor: colors.surface } : (theme === 'dark' ? styles.cosmicRingChipDark : styles.cosmicRingChipLight)]}
                  onPress={() => navigation.navigate('CosmicRing')}
                  activeOpacity={0.8}
                >
            ...
            {!transitData ? (
              ...
              <View>
                  {/* Mini Zodiac Map */}
                  <View style={[styles.miniZodiacContainer, isLightOrClassic && { backgroundColor: isClassic ? colors.backgroundSecondary : colors.surface, borderWidth: 1, borderColor: colors.cardBorder, borderRadius: 16 }]}>
                    <View style={styles.zodiacWheelWrapper}>
                        ...
                        {Object.entries(transitData.planets || {}).map(([planet, data], i) => {
                          ...
                          return (
                            <Circle 
                              ...
                              cy={y} 
                              r="5" 
                              fill={isClassic ? colors.text : getPlanetColor(planet)} 
                              opacity={1}
                      ...
                      {/* Center Glow */}
                      <View style={[styles.zodiacCenterGlow, isLightOrClassic && { backgroundColor: isClassic ? 'transparent' : 'rgba(249, 115, 22, 0.08)' }]} />
                    </View>
                          ...
                          return (
                            <View key={planet} style={[
                              ...
                              <View style={styles.transitCardHeader}>
                                {isClassic ? <Icon name="planet-outline" size={22} color={colors.text} style={{ marginRight: 4 }} /> : <Text style={styles.transitPlanetIcon}>{vibe.icon}</Text>}
                              ...
                              <View style={styles.transitMainInfo}>
                                ...
                                <View style={styles.statusBadges}>
                                  {status.map((s, idx) => (
                                    <View key={idx} style={[styles.statusBadge, { backgroundColor: isClassic ? (colors.textSecondary + '30') : (s.color + '20') }]}>
                                      <Text style={[styles.statusBadgeText, { color: isClassic ? colors.text : s.color }]}>{s.label}</Text>
                                    </View>
                                  ))}
                                </View>
                              </View>
                              ...
                              <View style={styles.transitSignRow}>
                                {isClassic ? <Text style={[styles.transitSignIcon, { fontSize: 12, color: colors.textTertiary }]}>•</Text> : <Text style={styles.transitSignIcon}>{getSignIcon(signIdx)}</Text>}
          ...
          {/* Panchang Timeline */}
          {panchangData && (
            <View style={[styles.panchangCard, androidLightCardFixStyle, isLightOrClassic && { backgroundColor: colors.cardBackground, borderColor: colors.cardBorder, borderWidth: 1 }, useGlass && { overflow: 'hidden' }]}>
              {useGlass && <BlurView intensity={48} style={StyleSheet.absoluteFill} tint={theme === 'dark' ? 'dark' : 'light'} />}
              {useGlass && <View style={[StyleSheet.absoluteFill, { backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.22)' }]} pointerEvents="none" />}
              <Text style={[styles.panchangTitle, { color: colors.text }]}>
                {t('home.panchang.title', '🌅 Today\'s Panchang')}
              </Text>
              <View style={[styles.panchangTitleUnderline, isLightOrClassic && { backgroundColor: colors.primary }]} />
              
              <View style={styles.sunTimesRow}>
                <View style={[styles.sunTimeItem, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : '#fffbf7', borderColor: colors.cardBorder }]}>
                  {isClassic ? <Icon name="sunny-outline" size={24} color={colors.text} style={{ marginBottom: 6 }} /> : <Text style={styles.sunTimeEmoji}>🌅</Text>}
                ...
                <View style={[styles.sunTimeItem, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : '#fffbf7', borderColor: colors.cardBorder }]}>
                  {isClassic ? <Icon name="partly-sunny-outline" size={24} color={colors.text} style={{ marginBottom: 6 }} /> : <Text style={styles.sunTimeEmoji}>🌇</Text>}
              ...
              <View style={styles.sunTimesRow}>
                <View style={[styles.sunTimeItem, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : '#fffbf7', borderColor: colors.cardBorder }]}>
                  {isClassic ? <Icon name="moon-outline" size={24} color={colors.text} style={{ marginBottom: 6 }} /> : <Text style={styles.sunTimeEmoji}>🌙</Text>}
                ...
                <View style={[styles.sunTimeItem, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : '#fffbf7', borderColor: colors.cardBorder }]}>
                  {isClassic ? <Icon name="moon" size={24} color={colors.textTertiary} style={{ marginBottom: 6 }} /> : <Text style={styles.sunTimeEmoji}>🌚</Text>}
              ...
              <View style={styles.dayProgressBar}>
                <View style={[styles.progressTrack, isLightOrClassic && { backgroundColor: 'rgba(0,0,0,0.1)' }, isClassic && { borderWidth: 1, borderColor: colors.cardBorder }]}>
                  {(() => {
                    const now = new Date();
                    ...
                    return (
                      <>
                        <View style={[styles.progressFill, { width: `${progress}%`, backgroundColor: isClassic ? colors.text : undefined }]} />
                        <View style={[styles.currentTimeDot, { left: `${progress}%`, backgroundColor: isClassic ? colors.text : undefined }]}>
                          <Icon name="sunny" size={12} color={isClassic ? colors.background : '#fff'} />
                        </View>
                      </>
                    );
                  })()}
              ...
              {panchangData.daily_panchang && (
                <View style={[styles.panchangElementsSection, isLightOrClassic && { borderWidth: 1, borderColor: colors.cardBorder, borderRadius: 16, padding: 16, backgroundColor: isClassic ? colors.backgroundSecondary : colors.cardBackground }]}>
                  ...
                  <View style={styles.panchangElementGrid}>
                    ...
                    {panchangData.daily_panchang.tithi && (
                      <View style={[styles.panchangElement, isLightOrClassic && { backgroundColor: isClassic ? colors.cardBackground : '#fffbf7', borderColor: colors.cardBorder }]}>
              ...
              <View style={styles.moonSectionRow}>
                <View style={styles.moonSvgContainer}>
                  ...
                  <Svg width="100" height="100" viewBox="0 0 100 100">
                    <Circle cx="50" cy="50" r="45" fill={isClassic ? colors.text : '#1a1a1a'} stroke={isClassic ? colors.cardBorder : 'rgba(255,255,255,0.05)'} strokeWidth="1" />
                    {(() => {
                      ...
                      const cx = 50;
                      const cy = 50;
                      const moonLitFill = isClassic ? colors.backgroundSecondary : '#f0f0f0';
                      
                      if (isNaN(illumination)) return <Circle cx="50" cy="50" r="43" fill={moonLitFill} />;
                      ...
                      if (isFull || illumination >= 98) return <Circle cx="50" cy="50" r="43" fill={moonLitFill} />;
                      
                      const ellipseRadiusX = r * Math.abs(1 - (2 * illumination / 100));
                      if (isNaN(ellipseRadiusX)) return <Circle cx="50" cy="50" r="43" fill={moonLitFill} />;
                      ...
                      return <Path d={pathData} fill={moonLitFill} stroke="none" />;
                    })()}
                  </Svg>
                </View>
              ...
              <View style={styles.dayQualityContainer}>
                ...
                <View style={styles.qualityTimelineWrapper}>
                  <View style={[styles.qualityTimelineTrack, theme === 'light' && { backgroundColor: 'rgba(0,0,0,0.06)', borderColor: 'rgba(0,0,0,0.12)' }, isClassic && { backgroundColor: 'rgba(0,0,0,0.08)', borderColor: colors.cardBorder }]}>
                    {(() => {
                      const now = new Date();
                      ...
                      if (panchangData.brahma_muhurta_start && panchangData.brahma_muhurta_end) {
                        ...
                        if (start !== null && end !== null) {
                          blocks.push(<View key="brahma" style={[styles.qualityBlock, { left: `${start}%`, width: `${end - start}%`, backgroundColor: isClassic ? colors.textSecondary : '#10B981' }]} />);
                        }
                      }
                      ...
                      if (panchangData.abhijit_muhurta_start && panchangData.abhijit_muhurta_end) {
                        ...
                        if (start !== null && end !== null) {
                          blocks.push(<View key="abhijit" style={[styles.qualityBlock, { left: `${start}%`, width: `${end - start}%`, backgroundColor: isClassic ? colors.textSecondary : '#10B981' }]} />);
                        }
                      }
                      ...
                      if (panchangData.rahu_kaal?.rahu_kaal_start && panchangData.rahu_kaal?.rahu_kaal_end) {
                        ...
                        if (start !== null && end !== null) {
                          blocks.push(<View key="rahu" style={[styles.qualityBlock, { left: `${start}%`, width: `${end - start}%`, backgroundColor: isClassic ? colors.textTertiary : '#EF4444' }]} />);
                        }
                      }
                      ...
                      panchangData.inauspicious_times?.dur_muhurta?.forEach((period, i) => {
                        ...
                        if (start !== null && end !== null) {
                          blocks.push(<View key={`dur-${i}`} style={[styles.qualityBlock, { left: `${start}%`, width: `${end - start}%`, backgroundColor: isClassic ? colors.textTertiary : '#EF4444', opacity: isClassic ? 0.8 : 0.7 }]} />);
                        }
                      });
                      ...
                      panchangData.inauspicious_times?.varjyam?.forEach((period, i) => {
                        ...
                        const end = getPos(period.end_time);
                        if (start !== null && end !== null) {
                          blocks.push(<View key={`varjyam-${i}`} style={[styles.qualityBlock, { left: `${start}%`, width: `${end - start}%`, backgroundColor: isClassic ? colors.textTertiary : '#EF4444', opacity: isClassic ? 0.6 : 0.5 }]} />);
                        }
                      });
                      ...
                      blocks.push(
                        <View key="now" style={[styles.qualityNowIndicator, { left: `${currentPos}%` }]}>
                          <View style={[styles.qualityNowDot, isClassic && { backgroundColor: colors.text, borderColor: colors.cardBorder }]} />
                          <View style={[styles.qualityNowLine, isClassic && { backgroundColor: colors.text }]} />
                        </View>
                      );
                ...
                <View style={styles.qualityLegend}>
                  <View style={styles.legendItem}>
                    <View style={[styles.legendDot, { backgroundColor: isClassic ? colors.textSecondary : '#10B981' }]} />
                    <Text style={[styles.legendText, { color: colors.textSecondary }]}>{t('home.panchang.auspicious', 'Auspicious')}</Text>
                  </View>
                  <View style={styles.legendItem}>
                    <View style={[styles.legendDot, { backgroundColor: isClassic ? colors.textTertiary : '#EF4444' }]} />
                ...
                <View style={styles.detailedTimingsContainer}>
                  {/* Auspicious */}
                  <View style={[styles.timingGroup, isLightOrClassic && { backgroundColor: isClassic ? colors.surface : 'rgba(16, 185, 129, 0.08)', borderWidth: 1, borderColor: isClassic ? colors.cardBorder : 'rgba(16, 185, 129, 0.2)' }]}>
                    <View style={styles.timingRow}>
                      <Text style={[styles.timingLabel, { color: colors.textSecondary }]}>{t('home.panchang.brahmaMuhurta', 'Brahma Muhurta')}</Text>
                      <Text style={[styles.timingValue, { color: isClassic ? colors.text : '#10B981' }]}>
                  ...
                  {/* Inauspicious */}
                  <View style={[styles.timingGroup, isLightOrClassic && { backgroundColor: isClassic ? colors.surface : 'rgba(239, 68, 68, 0.08)', borderWidth: 1, borderColor: isClassic ? colors.cardBorder : 'rgba(239, 68, 68, 0.2)' }]}>
                    {panchangData.rahu_kaal && (
                      <View style={styles.timingRow}>
                        <Text style={[styles.timingLabel, { color: colors.textSecondary }]}>{t('home.panchang.rahuKaal', 'Rahu Kaal')}</Text>
                        <Text style={[styles.timingValue, { color: isClassic ? colors.text : '#EF4444' }]}>
      ...
      {/* Bottom Tabs */}
      <View style={[styles.bottomTabs, isClassic && { borderTopWidth: 1, borderTopColor: colors.cardBorder }]}>
        <LinearGradient
          colors={theme === 'dark' ? ['#f97316', '#ea580c'] : isClassic ? [colors.background, colors.backgroundSecondary] : ['#ffffff', '#fff5f0']}
        ...
        {!IS_ASTROLOGY_ONLY && (
          <>
            ...
            >
              ...
              <Text style={[styles.tabLabel, { color: activeTab === 'events' ? (theme === 'dark' ? '#ffffff' : colors.primary) : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary), fontWeight: activeTab === 'events' ? '600' : '500' }]}>
        ...
        >
          <View style={styles.tabIconContainer}>
            <Svg width="22" height="22" viewBox="0 0 48 48">
              {/* Outer square */}
              <Rect x="2" y="2" width="44" height="44" fill="none" stroke={activeTab === 'charts' ? (isClassic ? colors.primary : (theme === 'dark' ? '#ffffff' : colors.primary)) : (isClassic ? colors.textTertiary : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary))} strokeWidth="3" />
              {/* Inner diamond */}
              <Polygon points="24,2 46,24 24,46 2,24" fill="none" stroke={activeTab === 'charts' ? (isClassic ? colors.textSecondary : '#ffd700') : (isClassic ? colors.textTertiary : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary))} strokeWidth="2" />
              {/* Diagonal lines creating triangular houses */}
              <Line x1="2" y1="2" x2="46" y2="46" stroke={activeTab === 'charts' ? (isClassic ? colors.primary : (theme === 'dark' ? '#ffffff' : colors.primary)) : (isClassic ? colors.textTertiary : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary))} strokeWidth="1.5" />
              <Line x1="46" y1="2" x2="2" y2="46" stroke={activeTab === 'charts' ? (isClassic ? colors.primary : (theme === 'dark' ? '#ffffff' : colors.primary)) : (isClassic ? colors.textTertiary : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary))} strokeWidth="1.5" />
            </Svg>
          </View>
          <Text style={[styles.tabLabel, { color: activeTab === 'charts' ? (theme === 'dark' ? '#ffffff' : colors.primary) : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary), fontWeight: activeTab === 'charts' ? '600' : '500' }]}>
        ...
        >
          ...
          <Text style={[styles.tabLabel, { color: activeTab === 'dashas' ? (theme === 'dark' ? '#ffffff' : colors.primary) : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary), fontWeight: activeTab === 'dashas' ? '600' : '500' }]}>
        ...
        >
          ...
          <Text style={[styles.tabLabel, { color: activeTab === 'you' ? (theme === 'dark' ? '#ffffff' : colors.primary) : (theme === 'dark' ? 'rgba(255, 255, 255, 0.7)' : colors.textTertiary), fontWeight: activeTab === 'you' ? '600' : '500' }]}>
            {t('home.tabs.you', 'You')}
          </Text>
        </TouchableOpacity>
      </View>
