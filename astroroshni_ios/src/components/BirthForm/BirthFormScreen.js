...
export default function BirthFormScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient colors={isClassic ? [colors.background, colors.backgroundSecondary] : (theme === 'dark' ? [colors.gradientStart, colors.gradientMid, colors.gradientEnd, colors.primary] : [colors.gradientStart, colors.gradientStart, colors.gradientStart, colors.gradientStart])} style={styles.gradient}>
          ...
          <KeyboardAvoidingView style={styles.keyboardAvoid} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            <View style={styles.header}>
              ...
              <View style={styles.headerTitleContainer}>
                <Ionicons name="person" size={20} color={isClassic ? colors.text : '#ff6b35'} />
            ...
            <View style={styles.progressContainer}>
              <View style={[styles.progressBar, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(0, 0, 0, 0.15)') }]}>
                <Animated.View style={[styles.progressFill, { width: progressWidth }]}>
                  <LinearGradient colors={isClassic ? [colors.text, colors.textSecondary] : ['#ff6b35', '#ffd700']} style={styles.progressGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} />
                </Animated.View>
              </View>
            ...
            >
              <Animated.View style={[styles.stepContainer, { opacity: fadeAnim, transform: [{ translateY: slideAnim }, { scale: scaleAnim }, { translateX: shakeAnim }] }]}>
                ...
                <View style={[styles.iconContainer, { elevation: getCardElevation(10) }]}>
                  <LinearGradient colors={isClassic ? [colors.surface, colors.backgroundSecondary] : ['#ff6b35', '#ffd700', '#ff6b35']} style={[styles.iconGradient, isClassic && { borderWidth: 1, borderColor: colors.cardBorder }]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
                    <Text style={[styles.stepIcon, isClassic && { color: colors.text }]}>{getStepIcon()}</Text>
                  </LinearGradient>
                </View>
                ...
                {step === 1 && (
                  <View style={styles.inputContainer}>
                    <TextInput
                      style={[styles.input, { color: colors.text, backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.15)' : 'rgba(0, 0, 0, 0.05)'), borderColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(0, 0, 0, 0.2)') }]}
                      value={formData.name}
                ...
                {step === 2 && (
                  <View style={styles.genderContainer}>
                    ...
                    >
                      <LinearGradient
                        colors={isClassic ? [colors.cardBackground, colors.backgroundSecondary] : (formData.gender === 'Male' ? ['#ff6b35', '#ff8c5a'] : theme === 'dark' ? ['rgba(255, 255, 255, 0.15)', 'rgba(255, 255, 255, 0.05)'] : ['rgba(249, 115, 22, 0.25)', 'rgba(249, 115, 22, 0.15)'])}
                        style={[styles.genderGradient, { borderColor: isClassic ? (formData.gender === 'Male' ? colors.primary : colors.cardBorder) : (formData.gender === 'Male' ? 'rgba(255, 107, 53, 0.5)' : theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(249, 115, 22, 0.3)') }]}
                      >
                    ...
                    >
                      <LinearGradient
                        colors={isClassic ? [colors.cardBackground, colors.backgroundSecondary] : (formData.gender === 'Female' ? ['#ff6b35', '#ff8c5a'] : theme === 'dark' ? ['rgba(255, 255, 255, 0.15)', 'rgba(255, 255, 255, 0.05)'] : ['rgba(249, 115, 22, 0.25)', 'rgba(249, 115, 22, 0.15)'])}
                        style={[styles.genderGradient, { borderColor: isClassic ? (formData.gender === 'Female' ? colors.primary : colors.cardBorder) : (formData.gender === 'Female' ? 'rgba(255, 107, 53, 0.5)' : theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(249, 115, 22, 0.3)') }]}
                      >
                        <Text style={styles.genderIcon}>♀️</Text>
                ...
                {step === 3 && (
                  <View style={styles.dateTimeContainer}>
                    <TouchableOpacity style={[styles.dateTimeCard, { elevation: getCardElevation(8) }]} onPress={() => setShowDatePicker(true)}>
                      <LinearGradient colors={isClassic ? [colors.cardBackground, colors.backgroundSecondary] : (theme === 'dark' ? ['rgba(255, 255, 255, 0.15)', 'rgba(255, 255, 255, 0.05)'] : ['rgba(249, 115, 22, 0.25)', 'rgba(249, 115, 22, 0.15)'])} style={[styles.dateTimeGradient, { borderColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(249, 115, 22, 0.3)') }]}>
                  ...
                  <View style={styles.inputContainer}>
                    <View style={styles.locationInputWrapper}>
                      ...
                      {showSuggestions && suggestions.length > 0 && (
                        <ScrollView
                          style={[styles.suggestionsList, { backgroundColor: isClassic ? colors.cardBackground : (theme === 'dark' ? 'rgba(30, 30, 30, 0.95)' : 'rgba(255, 255, 255, 0.98)'), borderColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(0, 0, 0, 0.2)'), elevation: getCardElevation(10) }]}
                        ...
                        >
                          {suggestions.map((suggestion) => (
                            <TouchableOpacity
                              key={suggestion.id}
                              style={[styles.suggestionItem, { borderBottomColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)') }]}
                    ...
                    {formData.latitude && formData.longitude && (
                      <View style={[styles.locationDetails, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.05)'), borderColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(0, 0, 0, 0.1)') }]}>
                        ...
                        <View style={[styles.coordinatesRow, { borderTopColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(0, 0, 0, 0.1)') }]}>
            ...
            <View style={styles.navigationContainer}>
              {step > 1 && (
                <TouchableOpacity style={[styles.navButton, { elevation: getCardElevation(5) }]} onPress={prevStep}>
                  <LinearGradient colors={isClassic ? [colors.surface, colors.backgroundSecondary] : (theme === 'dark' ? ['rgba(255, 255, 255, 0.2)', 'rgba(255, 255, 255, 0.1)'] : ['rgba(249, 115, 22, 0.25)', 'rgba(249, 115, 22, 0.15)'])} style={[styles.navGradient, isClassic && { borderWidth: 1, borderColor: colors.cardBorder }]}>
              ...
              <TouchableOpacity style={[styles.navButton, styles.navButtonPrimary, step === 1 && styles.navButtonFull, { elevation: getCardElevation(5) }]} onPress={nextStep} disabled={loading}>
                <LinearGradient colors={isClassic ? [colors.primary, colors.textSecondary] : ['#ff6b35', '#ff8c5a']} style={[styles.navGradient, isClassic && { borderWidth: 1, borderColor: colors.cardBorder }]}>
                  <Text style={[styles.navTextPrimary, isClassic && { color: colors.background }]}>{loading ? t('birthForm.buttons.processing', 'Processing...') : step === 5 ? t('birthForm.buttons.complete', 'Complete') : t('birthForm.buttons.next', 'Next')}</Text>
                  {step < 5 && <Ionicons name="arrow-forward" size={20} color={isClassic ? colors.background : COLORS.white} />}
                </LinearGradient>
              </TouchableOpacity>
            </View>
              ...
              <Modal visible={showDatePicker} transparent animationType="slide">
                <View style={styles.modalOverlay}>
                  <View style={styles.pickerContainer}>
                    <LinearGradient colors={isClassic ? [colors.cardBackground, colors.backgroundSecondary] : [COLORS.white, COLORS.lightGray]} style={styles.pickerGradient}>
                      <View style={[styles.pickerHeader, isClassic && { borderBottomColor: colors.cardBorder }]}>
                        <TouchableOpacity onPress={() => setShowDatePicker(false)}>
                          <Text style={[styles.pickerButton, { color: isClassic ? colors.textSecondary : undefined }]}>{t('birthForm.picker.cancel', 'Cancel')}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setShowDatePicker(false)}>
                          <Text style={[styles.pickerButton, styles.pickerButtonDone, { color: isClassic ? colors.primary : undefined }]}>{t('birthForm.picker.done', 'Done')}</Text>
                        </TouchableOpacity>
                      </View>
                      <DateTimePicker
                        value={formData.date}
