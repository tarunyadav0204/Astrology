  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={styles.container}>
        <StatusBar barStyle={isClassic ? 'dark-content' : colors.statusBarStyle} backgroundColor={colors.background} translucent={false} />
        <LinearGradient 
          colors={isClassic ? [colors.background, colors.backgroundSecondary] : (theme === 'dark' ? [colors.gradientStart, colors.gradientMid, colors.gradientEnd] : [colors.gradientStart, colors.gradientStart])} 
          style={StyleSheet.absoluteFill} 
        />
        
        <SafeAreaView style={styles.safeArea} edges={['top']}>
          <View style={styles.compactHeader}>
            <TouchableOpacity onPress={() => navigation.goBack()} style={[styles.closeButton, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.15)' : 'rgba(249, 115, 22, 0.25)') }]}>
            ...
            <TouchableOpacity 
              onPress={handleShare} 
              style={[styles.shareButton, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.15)' : 'rgba(249, 115, 22, 0.25)') }]}
              disabled={isSharing}
            >
              <Ionicons name="share-outline" size={18} color={colors.text} />
            </TouchableOpacity>
            <View style={[styles.chartPosition, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255, 255, 255, 0.15)' : 'rgba(249, 115, 22, 0.25)') }]}>
          ...
          {loading ? (
            <View style={styles.loadingContainer}>
              <View style={styles.loadingContent}>
                <View style={[styles.loadingOrb, isClassic && { shadowColor: colors.text }]}>
                  <LinearGradient colors={isClassic ? [colors.surface, colors.backgroundSecondary] : ['#ff6b35', '#ffd700']} style={[styles.loadingOrbGradient, isClassic && { borderColor: colors.cardBorder }]}>
                    <Text style={[styles.loadingOrbIcon, isClassic && { color: colors.text }]}>✨</Text>
                  </LinearGradient>
                </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                <View 
                  style={[
                    styles.mainContent,
                    isClassic ? { backgroundColor: colors.background } : (theme === 'dark' ? { backgroundColor: '#1a0033' } : { backgroundColor: '#fff5f0' })
                  ]}
                >
                  ...
                  {chartTypes.map((chart, index) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        isClassic && {
                          backgroundColor: currentChartIndex === index ? colors.surface : colors.backgroundSecondary,
                          borderWidth: 1,
                          borderColor: currentChartIndex === index ? colors.primary : colors.cardBorder,
                        },
                      ]}
                      onPress={() => changeChart(index)}
                      activeOpacity={0.7}
                    >
                      {!isClassic && currentChartIndex === index && <View style={[styles.activeGlow, { backgroundColor: colors.primary + '40' }]} />}
                      <Text style={[styles.navIcon, currentChartIndex === index && styles.navIconActive]}>{chart.icon}</Text>
                      <Text style={[styles.navText, { color: isClassic ? (currentChartIndex === index ? colors.text : colors.textSecondary) : (theme === 'dark' ? 'rgba(255, 255, 255, 0.6)' : 'rgba(0, 0, 0, 0.6)') }, currentChartIndex === index && !isClassic && { color: theme === 'dark' ? '#ffffff' : colors.primary, fontWeight: '800' }, currentChartIndex === index && isClassic && { color: colors.text, fontWeight: '800' }]}>
                        {chart.name.split(' ')[0]}
                      </Text>
                    </TouchableOpacity>
                  ))}
          ...
          >
            <View 
              style={[
                ...
                { 
                  backgroundColor: isClassic ? colors.cardBackground : (theme === 'dark' ? 'rgba(26, 0, 51, 0.98)' : 'rgba(255, 255, 255, 0.98)')
                }
              ]}
            >
              ...
              {selectedHouse && (
                <View style={{ height: height * 0.7 }}>
                  ...
                  >
                    ...
                    <View style={[styles.drawerSection, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.02)') }]}>
                  ...
                  <View style={[styles.drawerActions, { 
                    backgroundColor: isClassic ? colors.background : (theme === 'dark' ? 'rgba(26, 0, 51, 1)' : 'rgba(255, 255, 255, 1)'),
                    borderTopWidth: 1,
                    borderTopColor: isClassic ? colors.cardBorder : (theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)'),
                    paddingTop: 16,
                    ...
                    >
                      <Ionicons name="refresh-outline" size={20} color={isClassic ? colors.background : 'white'} />
                      <Text style={[styles.actionButtonText, { color: isClassic ? colors.background : undefined }]}>Make Ascendant</Text>
                    </TouchableOpacity>

                    <TouchableOpacity 
                      style={[styles.actionButton, { backgroundColor: isClassic ? colors.surface : (theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)') }]}
                      onPress={() => {
