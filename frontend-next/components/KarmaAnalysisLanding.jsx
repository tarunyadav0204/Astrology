  ...
  return (
    <article className="karma-landing" id="karma-guide">
      ...
      <section className="karma-landing-section" aria-labelledby="karma-how-heading">
        ...
        <p>
          Explore related tools: <a href={craHref('/panchang')}>daily Panchang</a>,{' '}
          <a href={craHref('/kundli-matching')}>Kundli matching</a>, <a href={craHref('/nakshatras')}>27 Nakshatras</a>, and{' '}
          <a href={craHref('/beginners-guide')}>Vedic astrology for beginners</a>.
        </p>
      </section>
